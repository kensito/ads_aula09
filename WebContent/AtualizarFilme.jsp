	...
	<div class="container">
		...
		<form action="manter_filmes.do" method="POST">
			<div id="actions" class="row">
				<div class="col-md-12">
					<button type="submit" class="btn btn-primary" name="acao"
						value="btn-atualizar-de-atualizar-filme-jsp">Atualizar</button>
			...
			<div class="form-group">
				<div class=row>
					<div class="col-md-4">
						<label>Gênero: </label> <select name="genero" class="form-control"
							required>
					...
					<div class="col-md-8">
						<label>Tí­tulo:</label><input type="text" class="form-control"
							name="titulo" value="${filme.titulo}" required />
					</div>
				</div>
			</div>
			<div class="form-group">
				...
				<div class=row>
					<div class="col-md-8">
						<label>Diretor: </label><input type="text" class="form-control"
							value="${filme.diretor}" name="diretor" />
					</div>
					<div class="col-md-4">
						<label>Lançamento: </label><input type="date" class="form-control"
							name="data_lancamento" value="${filme.dataLancamento}" />
					</div>
				</div>
			</div>
			<div class="form-group">
				<div class=row>
					<div class="col-md-8">
						<label>Pôster: </label><input type="text" class="form-control"
							name="poster_path" value="${filme.posterPath}" />
					</div>
					<div class="col-md-4">
						<label>Popularidade: </label><input type="number"
							class="form-control" name="popularidade"
